      ...
      <div className="relative z-10 container-custom section-padding text-center">
        <div className="max-w-4xl mx-auto space-y-8">
          <div className="space-y-6">
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-inter font-bold text-gray-900 tracking-tight leading-tight min-h-[120px] md:min-h-[160px] lg:min-h-[200px]">
              Kết nối những
